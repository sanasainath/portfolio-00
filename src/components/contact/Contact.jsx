  ...
  <div className='container contact__container'>
    ...
    <article className='contact__option'>
      ...
      <a href='mailto:sanasainath013@gmail.com' target='_blank'>
        Send a Message
      </a>
    ...
    <RiMessengerLine className='contact__option__icon'/>
      <h4>Sms</h4>
      <h5>sanasainath</h5>
      <a href='sms://+919390712622?body=Hello' target='_blank'>
        Send a SMS
      </a>
    ...
    <BsWhatsapp className='contact__option__icon'/>
      <h4>WhatsApp</h4>
      <h5>+123456789</h5>
      <a href='https://wa.me/+917386270521?text=Hello' target='_blank'>
        Send a Message
      </a>
